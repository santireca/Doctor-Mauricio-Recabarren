        ...
        <section class="flex my-auto items-center justify-center min-h-screen home-dark bg-fixed bg-gradient-to-t from-blue-200 to-blue-400 dark:bg-gradient-to-t dark:from-slate-900 dark:to-indigo-950 ">
          ...
          sm-m:flex-col-reverse sm-m:gap-5">
            ...
            sm:w-[320px]">
              ...
              <p className=" text-3xl my-5 text-gray-100 font-semibold
              laptop:text-xl laptop:my-5
              sm-m:text-xl sm-m:text-center sm-m:my-5
              sm:text-lg sm:text-center sm:my-5">MÉDICO PEDIATRA</p>
              <p className=" text-xl font-semibold text-blue-950 
              laptop:text-lg
              sm-m:text-lg sm-m:text-center
              sm:text-base sm:text-center">MP 7355</p>
            </div>
